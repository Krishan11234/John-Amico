                            ...
                            if($member_row_num < 0) {
                                ...
                                <div class="member_details_wrapper">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 text-center">Title: <strong><?php echo $active_members == 0 ? 'JA Member' : $row['str_designation']?></strong></div>
                                            ...
                                            <table class="table table-striped" style="color:black;">
                                                ...
                                                while($row2 = mysqli_fetch_array($result2))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="top" align="center"><?php echo $row2['level']?></td>
                                                        <td valign="top"><?php echo $active_members == 0 ? 'JA Member' : $row2['str_designation']?></td>
