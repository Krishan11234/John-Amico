<?php
$page_name = 'Manage Professionals';
...
$member_type_name = 'Professionals';
$member_type_name_plural = 'Professionals';
$self_page = 'ambassadors.php';
$page_url = base_admin_url() . '/ambassadors.php?1=1';
...
$is_edit = $is_add = $load_buttons = false;
...
if( (!empty($_POST['memberid']) && !empty($_POST['goto']) && ($_POST['goto'] == 'update') ) || (!empty($_GET['mid']) && validate_memberid($_GET['mid']) ) ) {
    ...
    $sql .= "mem.int_member_id, mem.int_designation_id,mem.amico_id,cus.customers_id,cus.customers_email_address,cus.customers_firstname,cus.customers_lastname,CONCAT(cus.customers_firstname,',',cus.customers_lastname) as fullname,mem.bit_active, mem.ec_id, mem.new_ec_id
        FROM tbl_member as mem
    ";
    $sql .= " INNER JOIN ".MAGENTO_TABLE_PREFIX."mvijaambassador as mviam ON mviam.applied_member_id = mem.int_member_id ";
