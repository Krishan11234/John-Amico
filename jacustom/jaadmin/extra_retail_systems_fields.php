<?php
$page_name = 'Retail Systems Extra Fields';
...
if( !empty($_POST['goto']) && ($_POST['goto'] == 'save')){
    ...
    $query = "TRUNCATE TABLE extra_retail_systems";
    mysqli_query($conn,$query);
    $query = "ALTER TABLE extra_retail_systems AUTO_INCREMENT = '1'";
    mysqli_query($conn,$query);
    ...
    foreach ($_POST['field']['title'] as $key => $val){
        ...
        if ($_POST['field']['title'][$i] != ''){
            $query = "insert into extra_retail_systems set title='".$_POST['field']['title'][$i]."', item_id='".$_POST['field']['item_id'][$i]."', category='".$_POST['field']['category'][$i]."'";
            mysqli_query($conn,$query);
        }
                ...
                <section class="panel">
                    <div class="col-md-10 col-sm-12 col-xs-12 centering">
                        ...
                        <div class="panel-body system_fields">
                            <?php
                            $q = mysqli_query($conn,"select * from extra_retail_systems order by category ASC");
