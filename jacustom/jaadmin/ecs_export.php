...
Header("Content-Disposition: attachment; filename=ECs.xls");
Header("Content-Description: Excel output");

$mtype='e';
$sql = "select m.growth, m.contest, m.int_member_id, m.int_designation_id,m.amico_id,c.customers_id,c.customers_email_address,c.customers_firstname,c.customers_lastname,m.bit_active from tbl_member m left outer join customers c on m.int_customer_id=c.customers_id  WHERE m.mtype='$mtype' order by c.customers_firstname";
