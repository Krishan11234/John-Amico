                            ...
                            if( !empty($user_amico_id) ) {
                                ...
                                while ($i < ($months_till_2006 + 2 + 10)) {
                                    ...
                                    $query = "
                                        ...
                                        WHERE tbl_member.amico_id = '$user_amico_id' AND bw_invoices.ID=tbl_member.amico_id AND bw_invoices.SKOEInvoice=bw_invoice_line_items.FKEntity
                                ...
                                while ($i < $months_till_2006) {
                                    ...
                                    <tr>
                                        ...
                                        WHERE tbl_member.amico_id = '$user_amico_id' AND bw_invoices.ID=tbl_member.amico_id AND bw_invoices.SKOEInvoice=bw_invoice_line_items.FKEntity AND bw_invoices.OrderDate>='" . date("Y-m-d H:i:s", mktime(0, 0, 0, date("m"), 1, date("Y") - 1)) . "' AND bw_invoices.OrderDate<='" . date("Y-m-d H:i:s", mktime(0, 0, 0, date("m"), 31, date("Y") - 1)) . "'";
                                        ...
                                        <?php
                                        //Number of members
                                        $nom_sql = "SELECT tbl_member_ec.ec_id FROM tbl_member_ec, tbl_member WHERE tbl_member.amico_id=tbl_member_ec.amico_id AND tbl_member_ec.amico_id = '$user_amico_id' AND event='added' AND timestamp<='" . date("Y-m-d H:i:s", mktime(0, 0, 0, date("m"), 31, date("Y"))) . "' GROUP BY tbl_member_ec.amico_id";
                                        $query = mysqli_query($conn, $nom_sql);

                                        $nom_sql2 = "SELECT tbl_member_ec.ec_id FROM tbl_member_ec, tbl_member WHERE tbl_member.amico_id=tbl_member_ec.amico_id AND tbl_member_ec.amico_id = '$user_amico_id' AND event='removed' AND timestamp<='" . date("Y-m-d H:i:s", mktime(0, 0, 0, date("m"), 31, date("Y"))) . "' GROUP BY tbl_member_ec.amico_id";
                                        $query2 = mysqli_query($conn, $nom_sql2);

                                        $nom_sql3 = "SELECT amico_id FROM customers c inner join tbl_member m ON c.customers_id=m.int_customer_id left outer join address_book a on c.customers_id=a.customers_id  WHERE m.amico_id='$user_amico_id' AND m.bit_active='1' GROUP BY m.amico_id";
                                        $query3 = mysqli_query($conn, $nom_sql3);

                                        $delta = mysqli_num_rows($query3) - ( mysqli_num_rows($query) - mysqli_num_rows($query2) );

                                        $nom_sql4 = "SELECT tbl_member_ec.ec_id FROM tbl_member_ec, tbl_member WHERE tbl_member.amico_id=tbl_member_ec.amico_id AND tbl_member_ec.amico_id = '$user_amico_id' AND event='added' AND timestamp<='" . date("Y-m-d H:i:s", mktime(0, 0, 0, date("m") - $i, 31, date("Y"))) . "' GROUP BY tbl_member_ec.amico_id";
                                        $query = mysqli_query($conn, $nom_sql4);

                                        $nom_sql5 = "SELECT tbl_member_ec.ec_id FROM tbl_member_ec, tbl_member WHERE tbl_member.amico_id=tbl_member_ec.amico_id AND tbl_member_ec.amico_id = '$user_amico_id' AND event='removed' AND timestamp<='" . date("Y-m-d H:i:s", mktime(0, 0, 0, date("m") - $i, 31, date("Y"))) . "' GROUP BY tbl_member_ec.amico_id";
                                        $query2 = mysqli_query($conn, $nom_sql5);
                                        $value = (mysqli_num_rows($query) - mysqli_num_rows($query2)) + $delta;


                                        //if( $value > 0  ) { echo '<pre>'; print_r( array($nom_sql, $nom_sql2, $nom_sql3, $delta, $nom_sql4, $nom_sql5, $value) ); die();}
                                        ...
                                        $sql = "SELECT bw_invoice_line_items.FKEntity FROM bw_invoices, bw_invoice_line_items, tbl_member
                                        WHERE tbl_member.amico_id = '$user_amico_id' AND bw_invoices.ID=tbl_member.amico_id AND bw_invoices.SKOEInvoice=bw_invoice_line_items.FKEntity
                                        ...
                                        <?php
                                        //New Members
                                        $query = mysqli_query($conn, "SELECT tbl_member_ec.ec_id FROM tbl_member_ec WHERE amico_id = '$user_amico_id' AND event='added'
                                        ...
                                        <?php
                                        //Lost Members
                                        $query = mysqli_query($conn, "SELECT tbl_member_ec.ec_id FROM tbl_member_ec WHERE amico_id = '$user_amico_id' AND event='removed'
                                           AND timestamp<='" . date("Y-m-d H:i:s", mktime(0, 0, 0, date("m") - $i, 31, date("Y"))) . "'
                                        ...
                                        elseif ($user_type == 'e' || $user_type == 'c') {
                                            $query_total = mysqli_query($conn, "SELECT ec_id FROM tbl_member WHERE amico_id='$user_amico_id'");
                                        }
                                        ...
                                        $query = mysqli_query($conn, "SELECT tbl_member_ec.ec_id FROM tbl_member_ec, tbl_member, customers
                                            ...
                                            AND tbl_member_ec.amico_id = '$user_amico_id'
