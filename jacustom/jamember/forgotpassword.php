...
if(!empty($_POST['submit'])){
    if ( !empty($_POST['email']) ){
        ...
        if( empty($email) ) {
            ...
            $entered_email = 1;
            // retrieve password
            $sql = "select c.customers_password, c.customers_email_address from customers c INNER JOIN tbl_member m ON m.int_customer_id=c.customers_id where c.customers_email_address='$email' and m.bit_active = 1";
            ...
            if(mysqli_num_rows($rs_AdminEmail) > 0) {
                ...
                if (!$Password == "") {
                    ...
                    $subject = "Member - Lost Password - John Amico";
                    $sitelink = "<a href='" . base_member_url() . "'>johnamico.com</a>";
                    ...
                    <div class="col-xs-10 col-xs-offset-1">
                        <form name="frmlogin" action="" method="post">
                            ...
                            <div class="form-group submit_wrapper">
                                ...
                                <div class="pull-left">
                                    <input type="button" name="Cancel" value="Cancel" class="warning" onclick="window.location='<?php echo base_member_url(); ?>/member_login.php'" >
                                </div>
                            </div>
                        </form>
                    </div>
