...
?>
    ...
    <script>
        function send_names() {
            ...
            window.opener.updateValue('chick_guests3', guestz);
            window.close();
        }
    </script>
                        ...
                        <footer class="panel-footer">
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <button type="Submit" name="submit" value="Save Names" class="command  btn btn-default btn-success mr-lg" onClick="send_names(); window.close()">Save Names</button>
