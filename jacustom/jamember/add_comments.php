...
$self_page = 'add_comments.php';
$page_url = base_member_url() . "/$self_page?";
$action_page = 'add_comments.php';
                                ...
                                <footer class="panel-footer">
                                    <div class="row">
                                        <div class="col-sm-9 centering text-center">
                                            ...
                                            <?php echo ( !empty($is_add) ? '<input type="submit" name="action" value="Add" class="command" title="">' : '<input type="submit" name="action" value="Update" class="command" title="">' ); ?>
                            ...
                            <div class="col-xs-12 centering">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 text-center font-size__20 mb-lg">
                                        <?php
                                        list($customers_first_name, $customers_last_name) = mysqli_fetch_row(mysqli_query($conn,"SELECT customers_firstname, customers_lastname FROM customers WHERE customers_id = '".$_GET["mlm_id"]."'"));
                                    ...
                                    <div class="col-xs-12 header_buttons_wrapper text-center">
                                        <div class="col-xs- add_button_wrapper centering">
                                            <form action="<?php echo $self_page; ?>?mlm_id=<?=$mlm_id?>" method="post">
                                                ...
                                                <button type="button" onclick="window.close();" class="btn btn-primary btn-warning ml-lg">Close Window</button>
                                            </form>
                                        </div>
                                    </div>
                                    <div class="mt-lg"></div>
