                                ...
                                <section class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-6">
                                                <a href="#" class="btn btn-primary pull-right" id="ec_custom_login_btn" disabled>Login as <?php echo explode("(", $parent_member_value)[0];?></a>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-xs-4 form-control-label" for="">Amico ID</label>
                                            <div class="col-xs-8">
                                                <p class="form-control-static" id="amico_id"><?php echo $memberGot_amico_id;?></p>
                                            </div>
                                        </div>
                                        <?php
                                        $ec_fields = array(
                                              ...
                                              // die();
                                                ...
                                                <?php else: ?>
                                                    <div class="form-group">
                                                        <label class="col-xs-4 form-control-label" for="<?php echo $ecf_k;?>"><?php echo $title; ?></label>
                                                        <div class="col-xs-8">
                                                          <?php if($value == 'email'): $amico_user_email = $$value;?>
                                                              <input type="hidden" id="ec_custom_login_key" name="ec_custom_login_key" value="<?php print base64_encode("$memberGot_amico_id::$amico_user_email::$user_mtype"); ?>">
                                                          <?php endif; ?>
